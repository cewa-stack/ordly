...
class TestSqliteOrderRepository:
    ...
    @pytest.mark.asyncio
    async def test_exists_zwraca_false_dla_niezapisanego_zamowienia(self, in_memory_session):
    ...
    @pytest.mark.asyncio
    async def test_unique_constraint_blokuje_duplikat(self, in_memory_session, sample_order):
    ...
    @pytest.mark.asyncio
    async def test_search_znajduje_po_nazwie_produktu(self, in_memory_session, sample_order):
