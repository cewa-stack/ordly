...
class TestWyciaganeDane:
    ...
    def test_wiadomosc_ma_kupujacego_z_linii_zdarzenia(self):
        ...
        assert event.buyer_login == "KUPIEC77"
        assert event.buyer_name == "Piotr"
        assert event.buyer == "KUPIEC77 (Piotr)"
