...
| Rola | Kolor |
|---|---|
| Kolor przewodni | Neon Lime `#C6FF00` |
| Tło | `#111111` |
| Tekst | `#FFFFFF` |
| Pomocniczy (powierzchnie) | `#2A2A2A` |
| Pomocniczy (tekst wyciszony) | `#666666` |

## Styl

Nowoczesny - Minimalistyczny - AI - Industrial - Premium

Pełny przewodnik: [docs/branding.md](../../docs/branding.md)
